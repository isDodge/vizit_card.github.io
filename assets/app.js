...
// ========================================
// SCROLL DOWN BUTTON - УЛУЧШЕННАЯ КНОПКА
// ========================================
...
function initVideoModal() {
  ...
  if (!videoModalOverlay || !workItems.length) return;
  ...
  workItems.forEach(item => {
    item.addEventListener('click', () => {
      ...
      if (videoFile) {
        ...
        // Для демо показываем placeholder
        // Когда добавите видео файлы, раскомментируйте код ниже:
        /*
        ...
        */
        ...
        // Показываем placeholder (для демо)
